        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    sectionBlock(
                        title: "Introduction",
                        content: "BitShrug (\"the App\") is committed to protecting your privacy. This Privacy Policy explains what information the App collects, how it is used, and your rights regarding that information."
                    )

                    sectionBlock(
                        title: "Information We Do Not Collect",
                        content: "BitShrug does not collect, store, or transmit any personal information. We do not collect your name, email address, phone number, location, IP address, device identifiers, or any other personally identifiable information. We do not use cookies, analytics, tracking pixels, or any third-party tracking services."
                    )
                    ...
                    sectionBlock(
                        title: "Local Storage",
                        content: "The App stores your preferences (such as notification settings and onboarding completion) locally on your device using UserDefaults. This data never leaves your device and is not accessible to BitShrug or any third party."
                    )

                    sectionBlock(
                        title: "In-App Purchases",
                        content: "Premium subscriptions are processed entirely by Apple through the App Store. BitShrug does not have access to your payment information, Apple ID, or billing details. All subscription management is handled by Apple."
                    )
