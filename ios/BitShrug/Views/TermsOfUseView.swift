            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    sectionBlock(
                        ...
                        content: "By downloading, installing, or using BitShrug (\"the App\"), you agree to be bound by these Terms of Use. If you do not agree to these terms, do not use the App."
                    )

                    sectionBlock(
                        title: "Description of Service",
                        content: "BitShrug is an educational application designed to help users understand Bitcoin market conditions, historical patterns, and mathematical models. The App displays delayed market data, calculated indicators, and educational content. BitShrug is NOT a financial advisory service, brokerage, exchange, or trading platform."
                    )
                    ...
                    sectionBlock(
                        title: "Data Accuracy",
                        content: "The App displays delayed market data obtained from third-party sources. Prices and indicators are not real-time. Calculated indicators are mathematical estimates that may differ from values reported by professional analytics platforms. BitShrug makes no warranty regarding the accuracy, completeness, or timeliness of any data displayed."
                    )
                    ...
                    sectionBlock(
                        ...
                        content: "All content, design, and code in BitShrug are the intellectual property of the developer. You may not copy, modify, distribute, or reverse-engineer the App or its contents."
                    )

                    sectionBlock(
                        title: "Limitation of Liability",
                        content: "To the maximum extent permitted by applicable law, BitShrug and its developers shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or other intangible losses, resulting from your use of or inability to use the App, or any decisions made based on information provided by the App."
                    )
