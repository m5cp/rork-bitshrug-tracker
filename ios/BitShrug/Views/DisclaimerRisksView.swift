        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    sectionBlock(
                        title: "No Guarantee",
                        content: "TouchGrass BTC makes no guarantees about the accuracy, completeness, or timeliness of any information provided. The developers of TouchGrass BTC are not responsible for any losses, damages, or costs arising from the use of this app or reliance on any information contained within it."
                    )
