        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    sectionBlock(
                        title: "Feedback",
                        content: "We welcome feedback about the accessibility of BitShrug. If you encounter accessibility barriers or have suggestions for improvement, please contact us through the App Store listing. We take accessibility feedback seriously and will work to address any issues."
                    )
                }
